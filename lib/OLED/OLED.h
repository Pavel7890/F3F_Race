...
// Switches to CHAR / Graphis Mode
#define LCD_SETGRAPHICMODE 0x1F
#define LCD_SETCHARMODE 0x17


class OLED : public Print {
public:
  OLED(uint8_t ver, uint8_t rs, uint8_t rw, uint8_t enable,
  ...
  void drawDigit(byte digit, byte pos);
  void drawDot(byte pos);
